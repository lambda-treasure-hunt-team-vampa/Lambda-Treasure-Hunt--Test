...
u=User(username="shelluser", password="testpassword")
u.is_superuser = True
u.is_admin = True
u.save()
print(f"User {u.username}'s API key is `{u.auth_token}`")
p = u.player
p.group = g
p.save()
